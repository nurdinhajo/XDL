  ...
  return (
    <div className="privacy">
      ...
      <div className="data-privacy">
        ...
        and the measures we take to keep it safe. 
        ...
        <b>• To connect you with a driver:</b> 
        ...
        <b> • We help you keep track of your ride:</b>
        We help drivers
        ...
        <b>• To make sure your smooth journey:</b>
        ...
        <b>• We make sure the optimal app performance:</b>
        ...
        <b>• To make sure to offer a quick, cheap, and most convenient ride to
        you:</b> 
        ...
        rideshare and cab.
        <b>• We maintain and promote standards:</b>
        ...
        you're trying to get around the obligations. 4. Recipients We only work
        ...
        as well as other demographic information. • After availing the
        ...
        driver and get the issue resolved with that passenger. • Riders give
        ...
        longer be accurate. • It is in some cases legally compelled to share
        information with external recipients, such as when a court orders us or
        when we cooperate with a data protection supervisory authority.  • We
        ...
        justification. 5. Security of Your Personal Data Data security is one of
        ...
        storage would be 100% secure. 6. Children's Privacy We do not address
        ...
        Our servers. If this happens, We remove the information from Our
        ...
        unless you give us their permission. 7. Links to Other Websites We may
        ...
        important that you read the privacy policy for every site you visit. We
        do not censor any 3rd party sites or the content on those sites. We have
        no control over and assume no responsibility for the content,
        protections, privacy policies, or practices of any third party site with
        which we are linked. 8. Changes to this Privacy Policy We will update
        our Privacy Policy from time to time. If a change is made, we'll notify
        You via the Forum or via other means. Email or a prominent notice before
        ...
        updated" date at the top of this Privacy Policy. Visitors should
        ...
        until a new copy is posted to this page. 9. Your rights and controls We
        want you to remain in control of your personal data. We provide you with
        ...
        opt-ins, and clear cookie consent controls on our app. Your right of
        access • You have the right to ask for a copy of any personal
        ...
        against those of others. Your right to rectification • You can get
        better assistance with all your personal data on the app. You also have
        ...
        everything booted up and running smoothly. Your right to erasure • You
        can request that your personal information that's stored on our servers
        be removed in certain circumstances Your right to restriction of
        processing • You have the right to ask us to restrict the processing of
        ...
        Your right to object to processing • We're processing your data on the
        basis of legitimate interests. If you want to object, you can tell us
        that and ask for a person to review it. 10. Retention Our app stores
        users' data only for as long as it needs to comply with their policies.
        ...
        billing data, 12 months for location data). • After having an active
        ...
        retention schedules and rules. • Data on transportation services
        ...
        years after the last journey. • We maintain all necessary data for
        internal, legal, and regulatory requirements to ensure we're a compliant
        company • In case of payment claims, your personal information will be
        retained unless it is satisfied or the claim expires. • The personal
        journey history and usage data of any individual will be stored for 3
        ...
        or we're legally obligated to keep this data for longer periods. Contact
        Us If you have any questions about this Privacy Policy, You can contact
        us: By email: management@xobo.co.ke
      </div>
