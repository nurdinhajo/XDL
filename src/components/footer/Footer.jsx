  ...
  return (
    <footer>
      <div className="footerLogo">
        <img
          loading='lazy' 
          src={process.env.PUBLIC_URL + '/media/Header-Logo.jpeg'} alt="XOBO Logo" 
        />
      ...
      <div className="moreLinks">
        ...
        <div className="socialIcons">
          <a href='https://twitter.com/XoboDelivery_' target='blank'>
            <img 
              loading='lazy'
              src={process.env.PUBLIC_URL + '../ICONS/XDL-X.png'} alt="XOBO X" />
          </a>
          
          <a href='https://www.facebook.com/XoboDelivery/' target='blank'>
            <img 
              loading='lazy'
              src={process.env.PUBLIC_URL + '../ICONS/XDL-FACEBOOK.png'} alt="XOBO FaceBook" />
          </a>

          <a href='https://www.instagram.com/xobo_delivery/' target='blank'>
            <img 
              loading='lazy'
              src={process.env.PUBLIC_URL + '../ICONS/XDL-INSTAGRAM.png'} alt="XOBO Instagram" />
          </a>

          <a href='https://www.youtube.com/@xobodelivery1476' target='blank'>
            <img  
              loading='lazy'
              id='youtube' src={process.env.PUBLIC_URL + '../ICONS/XDL-YOUTUBE.png'} alt="XOBO YouTube" />
          </a>
